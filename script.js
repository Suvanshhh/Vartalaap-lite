// apikey = AIzaSyCtRTEjLB381679mtUl9grSxJOsTk52vR8

// URL = https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyCtRTEjLB381679mtUl9grSxJOsTk52vR8
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function generateResponse(prompt) {
      const response = await fetch(
        `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyCtRTEjLB381679mtUl9grSxJOsTk52vR8`,
        {
          method: "POST",
          headers: {
